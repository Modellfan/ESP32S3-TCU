...
#define TCALL_RDM_SHARED_SECRET "replace-with-a-long-random-secret"
#define TCALL_RDM_LTE_ALIVE_AUTOSTART 1
#define TCALL_RDM_STANDBY_ENABLED 1
#define TCALL_RDM_STANDBY_AFTER_MS 60000UL
#define TCALL_RDM_STANDBY_WAKE_INTERVAL_MS 15000UL
#define TCALL_RDM_STANDBY_PROBE_WINDOW_MS 7000UL
